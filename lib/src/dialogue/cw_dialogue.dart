import 'package:coarse_widgets/src/dialogue/index.dart';
...
* */
class CWDialog {
  /// A General CW Dialog Widget to return specific AlertDialog Widget based on passed
  ...
  static void display({
    ...
    CWDialogType type = CWDialogType.Default,
